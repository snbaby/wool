let tdist = {
  ...
  57: ['\u8fea\u6208\u52a0\u897f\u4e9a\u5c9b', '0', 'di ge jia xi ya dao', 'Diego Garcia'],
  ...
  96: ['\u4f0a\u6717', '0', 'yi lang', 'Islamic Republic of Iran'],
  ...
  136: ['\u4e2d\u9014\u5c9b(\u7f8e)', '0', 'zhong tu dao (mei )', 'Midway Island'],
  ...
  176: ['\u963f\u68ee\u677e(\u82f1)', '0', 'a sen song (ying )', 'Saint Helena, Ascension and Tristan da Cunha'],
  ...
  244: ['\u5c3c\u7ef4\u65af\u5c9b', '0', 'ni wei si dao', 'Saint Kitts and Nevis'],
  ...
  255: ['\u6cd5\u56fd\u672c\u571f', '0', 'fa guo ben tu', 'France Metropolitan'],
  ...
  1353: ['\u65b0\u90a6\u62c9\u8d3e\u5b89\u5e15', '1003', 'xin bang la jia an pa', 'Simpang Ampat'],
...
const parents = data.filter(value => value.pid === '1')
const children = data.filter(value => value.pid !== '1' && value.pid !== '0')
...
//   const parents = data.filter(value => value.pid === '1')
//   console.log(parents)
//   const children = data.filter(value => value.pid !== '1' && value.parentCode !== '0')
...
//   return parents
// }
// translateDataToTree(vlist)
// console.log(translateDataToTree(vlist))
// Object.values(tdist).forEach(value => {
//   console.log(value)
// })
// let data = {
//   options: []
// }
// // 添加省
// function initData (tdist, id) {
//   let data = []
//   for (let key in tdist) {
//     if (parseInt(tdist[key][1]) === id) {
//       let tmp = {
//         value: tdist[key][0],
//         label: tdist[key][0],
//         id: key,
...
//   return data
// }
// data.options = initData(tdist, 1)
// data.options.forEach(item => {
//   item.children = initData(tdist, item.id)
// })
// console.log(data)
//
function translateDataToTree (data) {
  const parents = data.filter(value => value.parentCode === '1')
  const children = data.filter(value => value.parentCode !== 'undefined' && value.parentCode != null && value.parentCode !== '-1')
  const translator = (parents, children) => {
    parents.forEach((parent) => {
      children.forEach((current, index) => {
